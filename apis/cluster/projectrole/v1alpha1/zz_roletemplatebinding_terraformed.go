...
func (tr *RoleTemplateBinding) GetObservation() (map[string]any, error) {
...
func (tr *RoleTemplateBinding) SetObservation(obs map[string]any) error {
...
func (tr *RoleTemplateBinding) GetParameters() (map[string]any, error) {
...
func (tr *RoleTemplateBinding) SetParameters(params map[string]any) error {
...
// GetInitParameters of this RoleTemplateBinding
func (tr *RoleTemplateBinding) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RoleTemplateBinding
func (tr *RoleTemplateBinding) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
