...
func (tr *V2) GetObservation() (map[string]any, error) {
...
func (tr *V2) SetObservation(obs map[string]any) error {
...
func (tr *V2) GetParameters() (map[string]any, error) {
...
func (tr *V2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this V2
func (tr *V2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this V2
func (tr *V2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
