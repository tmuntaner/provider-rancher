...
type RoleTemplateBindingInitParameters struct {
...
type RoleTemplateBindingSpec struct {
	...
	// autoscaler.
	InitProvider RoleTemplateBindingInitParameters `json:"initProvider,omitempty"`
}
...
// RoleTemplateBinding is the Schema for the RoleTemplateBindings API. "Managed resource"page_title: "rancher2_project_role_template_binding Resource"
