...
PROJECT_REPO ?= github.com/tmuntaner/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 8.5.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-rancher2
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-rancher2_v8.5.0
